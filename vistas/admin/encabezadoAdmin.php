...
<head>
    <meta charset="utf-8" />
    <title>Proyecto Yacumama - Administrador</title>
    ...
    <link rel="apple-touch-icon" href="/img/logo-top.png">
            ...
            <div class="left navside dark dk" data-layout="column">
                <div class="navbar no-radius">
                    ...
                    <a class="navbar-brand">
                        <img src="/img/logo-top.png" alt="." class="hide">
                ...
                <div class="hide-scroll" data-flex>
                    <nav class="scroll nav-light">
                        ...
                        <ul class="nav" ui-nav>
                            ...
                            <li>
                                <a href="?c=users&a=InterfazPrincipalAdmin">
                                    <span class="nav-icon">
                            ...
                            <li>
                                <a href="?c=users&a=InterfazPedidosDia">
                                    <span class="nav-icon">
